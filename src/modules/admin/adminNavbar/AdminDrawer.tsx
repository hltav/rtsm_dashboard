...
import { DrawerComponentProps } from "@/modules/dashboard/interface/drawerComponentProps";
import { AdminMenuItem, adminMenuItems } from "./AdminMenuItens";
import { useAdmin } from "@/components/Providers/AdminContext";


const AdminDrawerComponent: React.FC<DrawerComponentProps> = ({
  open,
  handleDrawerToggle,
  onMenuItemClick,
}) => {
