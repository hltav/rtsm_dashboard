...
const EventPage = () => {
  ...
  }; // Funções para o Modal de Edição (Edit)

  const handleOpenEditModal = (eventItem: EventItem) => {
    setSelectedEventForEdit({ ...eventItem }); // Cria uma cópia para edição
  ...
  const handleClearFilters = () => {
    ...
    setFilterResult("");
  }; // Coleta valores únicos para os dropdowns dos filtros
  ...
  const amountRanges = ["", "0-10", "10-20", "20-50", "50+"]; // Lógica de filtragem
