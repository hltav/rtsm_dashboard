...
export const BankrollSchema = z.object({
  ...
  initialBalance: z.coerce.number().nonnegative({ message: "Saldo inicial não pode ser negativo" }),
  statusSync: z.enum(["Synchronizing", "Synchronized"], { message: "Status de sincronização inválido" }),
